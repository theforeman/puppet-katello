...
class katello::pulp (
  ...
  Boolean $yum_gpg_sign_repo_metadata = $katello::pulp_yum_gpg_sign_repo_metadata,
  Optional[String] $yum_gpg_key_id = $katello::pulp_yum_gpg_key_id,
  Optional[String] $yum_gpg_cmd = $katello::pulp_yum_gpg_cmd,
  Boolean $yum_regenerate_repomd_signatures = $katello::pulp_yum_regenerate_repomd_signatures,
  ...
  class { 'pulp':
    ...
    yum_gpg_sign_repo_metadata       => $yum_gpg_sign_repo_metadata,
    yum_gpg_key_id                   => $yum_gpg_key_id,
    yum_gpg_cmd                      => $yum_gpg_cmd,
    yum_regenerate_repomd_signatures => ($yum_regenerate_repomd_signatures or $certs::regenerate_ca or $certs::regenerate),
